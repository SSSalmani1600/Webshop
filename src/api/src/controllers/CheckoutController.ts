...
export class CheckoutController {
    ...
    public async createAddress(req: Request, res: Response): Promise<void> {
        ...
        console.log("REQ BODY:", req.body);
            ...
            const naam: string = typeof body.naam === "string" ? body.naam : "";
            const straatHuisnummer: string = typeof body.straatHuisnummer === "string" ? body.straatHuisnummer : "";
            const postcodePlaats: string = typeof body.postcodePlaats === "string" ? body.postcodePlaats : "";
            const telefoonnummer: string = typeof body.telefoonnummer === "string" ? body.telefoonnummer : "";
