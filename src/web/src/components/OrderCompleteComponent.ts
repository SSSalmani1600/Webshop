...
export class OrderCompleteComponent extends HTMLElement {
    ...
    private renderOrder(games: BoughtGame[]): void {
        ...
        // Get discount information from URL
        ...
        const discountedTotal: number = discountPercentage > 0 ? total * (1 - discountPercentage / 100) : total;
                ...
                <div class="order-container">
                    ...
                    <div class="order-content">
                        ...
                        <div class="order-box">
                            ...
                            ${discountCode
                                ? `
                                    <div class="order-total" style="color: #703bf7; font-weight: normal;">
                            ...
                            <div class="order-total" style="margin-top: 8px; border-top: 1px solid rgba(255, 255, 255, 0.1); padding-top: 8px;">
                                <span>Totaal:</span>
